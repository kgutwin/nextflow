...
/**
 * Defines the script operation to handle file when running in the ihpc cluster
 *
 * @author Paolo Di Tommaso <paolo.ditommaso@gmail.com>
 */
@Slf4j
@CompileStatic
class IhpcFileCopyStrategy extends SimpleFileCopyStrategy {

    Path workDir

    IhpcFileCopyStrategy( TaskBean task ) {
